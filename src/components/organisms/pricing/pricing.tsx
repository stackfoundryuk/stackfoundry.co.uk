...
import {
  ButtonLink,
  ButtonLinkProps,
} from "@/components/molecules/button-link/button-link";
import { BackgroundGradient } from "@/components/molecules/gradients/background-gradient";
import { Section, SectionProps, SectionTitle } from "@/components/molecules/section";
...
const PricingFeatures: React.FC<React.PropsWithChildren<object>> = ({
  children,
}) => {
  return (
    <VStack
